...
function selectTheme(selectedTheme: "system" | "light" | "dark") {
      ...
      >
        <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6 mr-2">
          <path
            ...
            :class="
              theme === 'system'
                ? 'stroke-emerald-500 fill-emerald-400/20'
        ...
        <div
          ...
          :class="{ 'text-emerald-500': theme === 'system' }"
        >
          System
        </div>
      </li>
      ...
      >
        ...
        >
          <path
            ...
            :class="
              theme === 'light'
                ? 'fill-emerald-400/20 stroke-emerald-500'
                : 'stroke-slate-400 dark:stroke-slate-500'
            "
          ></path>
          <path
        ...
        <div
          class="text-md font-semibold"
          :class="{ 'text-emerald-500': theme === 'light' }"
        >
          Light
        </div>
      </li>
      ...
      >
        <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6 mr-2">
          <path
            ...
            class=""
            :class="
              theme === 'dark' ? 'fill-emerald-400/20' : 'fill-transparent'
            "
          ></path>
          <path
        ...
        <div
          class="text-md font-semibold"
          :class="{ 'text-emerald-500': theme === 'dark' }"
        >
          Dark
        </div>
      </li>
